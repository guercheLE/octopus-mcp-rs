...
use octopus_mcp::core::api_url_builder::build_api_url;
use octopus_mcp::core::config_manager::load_config;
use octopus_mcp::core::config_schema::Transport;

async fn probe(
    config: &octopus_mcp::core::config_schema::Config,
...
mod tests {
    ...
    fn config(url: String) -> octopus_mcp::core::config_schema::Config {
